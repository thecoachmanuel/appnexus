...
export const adminApi = {
  ...
  updateUserRole: (userId: string, role: string | null) => handleApi(Promise.resolve({})),
  ...
  createPlan: (...args: any[]) => handleApi(Promise.resolve({})),
  updatePlan: (...args: any[]) => handleApi(Promise.resolve({})),
  getCreditPacks: () => handleApi(fetchApi('/api/credit-packs')),
  createCreditPack: (...args: any[]) => handleApi(Promise.resolve({})),
  updateCreditPack: (...args: any[]) => handleApi(Promise.resolve({})),
  deleteCreditPack: (...args: any[]) => handleApi(Promise.resolve({})),
  getSettings: () => handleApi(fetchApi('/api/settings')),
  updateSetting: (key: string, value: string | number | boolean | Record<string, unknown>) => handleApi(Promise.resolve({})),
